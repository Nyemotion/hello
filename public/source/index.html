	...
	<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 256 Nguyễn Văn Cừ Ninh Kiều Cần Thơ</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0163 296 678</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="images/product/111.jpg" width="200px" alt=""></a>
				</div>
					...
					<div class="widget">
						...
						<div>
							<div class="contact-info">
								...
								<p>256 Nguyễn Văn Cừ Ninh Kiều, Cần Thơ  Phone: +78 123 456 78</p>
								<p>Theme Made by 2 cô gái .</p>
							</div>
						</div>
					</div>
				  </div>
